...
extern void F1005_10511(EIF_REFERENCE, int);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1004, Current, 2, 5, 15849);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1004, Current, 15849);
	RTCC(arg2, 1004, l_feature_name, 2, eif_new_type(1024, 0x01), 0x01);
	RTIV(Current, RTAL);
...
body:;
	...
	*(EIF_REFERENCE *)(Current + RTWA(7468, dtype)) = (EIF_REFERENCE) RTCCL(arg2);
	...
	RTNHOOK(7,1);
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(7831, "bytes_per_pixel", tr1))(tr1)).it_i4);
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1004, Current, 0, 0, 15850);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1004, Current, 15850);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F1005_9652 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1004, Current, 0, 0, 15856);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1004, Current, 15856);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1005_10511 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1004, Current, 0, 10510);
	RTSA(dtype);
	RTME(dtype, 0);
	RTIT("exists", Current);
	tb1 = '\01';
