...
extern void F1008_10512(EIF_REFERENCE, int);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1007, Current, 0, 3, 15864);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1007, Current, 15864);
	RTCC(arg1, 1007, l_feature_name, 1, eif_new_type(1024, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 7472, 0x10000000, 1); /* bytes_per_pixel */
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(7831, "bytes_per_pixel", arg1))(arg1)).it_i4);
	*(EIF_INTEGER_32 *)(Current + RTWA(7472, dtype)) = (EIF_INTEGER_32) ti4_1;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 7468, 0xF8000400, 0); /* pixel_format */
	RTAR(Current, arg1);
...
#define ui4_2 ui4_2x.it_i4
	...
	if ((RTAL & CK_REQUIRE) || RTAC) {
		...
		RTNHOOK(4,1);
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(7753, "is_indexed", tr1))(tr1)).it_b);
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1007, Current, 0, 2, 15866);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1007, Current, 15866);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("is_item_valid", EX_PRE);
		...
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7468, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		RTNHOOK(5,1);
		ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(7830, "bits_per_pixel", tr1))(tr1)).it_i4);
...
void F1008_10512 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1007, Current, 0, 10511);
	RTSA(dtype);
	RTME(dtype, 0);
