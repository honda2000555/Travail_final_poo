...
extern void F982_8743(EIF_REFERENCE);
extern EIF_TYPED_VALUE F982_8744(EIF_REFERENCE);
extern EIF_TYPED_VALUE F982_8745(EIF_REFERENCE);
extern void F982_8747(EIF_REFERENCE);
extern void F982_8748(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F982_8749(EIF_REFERENCE);
extern void F982_8750(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F982_8751(EIF_REFERENCE);
extern EIF_TYPED_VALUE F982_8752(EIF_REFERENCE);
extern EIF_TYPED_VALUE F982_8753(EIF_REFERENCE);
extern void F982_8754(EIF_REFERENCE);
extern EIF_TYPED_VALUE F982_8755(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F982_8756(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F982_8757(EIF_REFERENCE);
extern EIF_TYPED_VALUE F982_8758(EIF_REFERENCE);
extern void F982_8759(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F982_8760(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F982_8761(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F982_8762(EIF_REFERENCE);
...
/* {THREAD}.make */
void F982_8743 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 981, Current, 0, 0, 14935);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(981, Current, 14935);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, Dtype(Current), 6608, 0xF80000AC, 0); /* launch_mutex */
...
/* {THREAD}.thread_id */
EIF_TYPED_VALUE F982_8744 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_POINTER;
...
/* {THREAD}.terminated */
EIF_TYPED_VALUE F982_8745 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
/* {THREAD}.launch */
void F982_8747 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 981, Current, 0, 0, 14938);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(981, Current, 14938);
	RTIV(Current, RTAL);
...
body:;
	...
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWC(8184, Dtype(tr1)))(tr1);
	RTNHOOK(3,1);
	ur1 = RTCCL(tr1);
...
void F982_8748 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 981, Current, 0, 1, 14939);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(981, Current, 14939);
	RTCC(arg1, 981, l_feature_name, 1, eif_new_type(1035, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("thread_capable", EX_PRE);
...
/* {THREAD}.exit */
void F982_8749 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 981, Current, 0, 0, 14940);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(981, Current, 14940);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
/* {THREAD}.sleep */
void F982_8750 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui8_1 ui8_1x.it_i8
	...
	RTEAA(l_feature_name, 981, Current, 0, 1, 14941);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(981, Current, 14941);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("self", EX_PRE);
...
EIF_TYPED_VALUE F982_8751 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 981, Current, 0, 0, 14942);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(981, Current, 14942);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F982_8752 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 981, Current, 0, 0, 14943);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(981, Current, 14943);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
	tb1 = '\0';
...
EIF_TYPED_VALUE F982_8753 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 981, Current, 0, 0, 14944);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(981, Current, 14944);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {THREAD}.join */
void F982_8754 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 981, Current, 0, 0, 14945);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(981, Current, 14945);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F982_8755 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu8_1 uu8_1x.it_n8
	...
	RTEAA(l_feature_name, 981, Current, 0, 1, 14946);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(981, Current, 14946);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = *(EIF_BOOLEAN *)(Current + RTWA(6596, dtype));
	if (tb1) {
...
#undef EIF_VOLATILE
#define EIF_VOLATILE volatile
void F982_8756 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 981, Current, 0, 1, 14947);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(981, Current, 14947);
	RTIV(Current, RTAL);
	RTE_T
	RTHOOK(1);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6608, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
...
/* {THREAD}.launch_mutex */
EIF_TYPED_VALUE F982_8757 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
RTOID (F982_8758)
EIF_TYPED_VALUE F982_8758 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 981, Current, 0, 0, 14949);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(981, Current, 14949);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
void F982_8759 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define arg3 arg3x.it_p
	...
	RTEAA(l_feature_name, 981, Current, 0, 3, 14950);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
	RTDBGEAA(981, Current, 14950);
	RTCC(arg1, 981, l_feature_name, 1, eif_new_type(981, 0x01), 0x01);
	RTIV(Current, RTAL);
	{
...
/* {THREAD}.thread_wait */
void F982_8760 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 981, Current, 0, 1, 14951);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
	RTDBGEAA(981, Current, 14951);
	RTCC(arg1, 981, l_feature_name, 1, eif_new_type(981, 0x01), 0x01);
	RTIV(Current, RTAL);
	{
...
EIF_TYPED_VALUE F982_8761 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define arg2 arg2x.it_n8
	...
	RTEAA(l_feature_name, 981, Current, 0, 2, 14952);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
	RTDBGEAA(981, Current, 14952);
	RTCC(arg1, 981, l_feature_name, 1, eif_new_type(981, 0x01), 0x01);
	RTIV(Current, RTAL);
	{
		EIF_OBJECT larg1 = &arg1;
...
EIF_TYPED_VALUE F982_8762 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 981, Current, 0, 0, 14953);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
	RTDBGEAA(981, Current, 14953);
