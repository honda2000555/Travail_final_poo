...
void egc_init_plug (void)
{
	...
	egc_system_name = "travail_poo";
	egc_system_location = "C:\\Users\\charl\\Desktop\\Projet\\Travail_final_poo\\EIFGENs\\travail_poo\\W_code";
	egc_compiler_tag = 38;
	egc_project_version = 1486497709;
	...
	egc_rlist[0] = "GAME2_APPLICATION.make";
	egc_rcdt[0] = 0;
	egc_rcrid[0] = 8204;
	egc_rcarg[0] = 0;
...
{
	if (egc_rcdt[0] == 0) {
		egc_rcdt[0] = 1036; /* GAME2_APPLICATION */
	}
}
