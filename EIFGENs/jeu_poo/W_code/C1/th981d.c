...
static const EIF_TYPE_INDEX egt_13_981 [] = {0xFF01,172,0xFFFF};
static const EIF_TYPE_INDEX egt_14_981 [] = {0xFF01,912,198,0xFFFF};
...
static const struct desc_info desc_981[] = {
	...
	{EIF_NON_GENERIC(0x01BD /*222*/), 14935, 16},
	{EIF_NON_GENERIC(0x018D /*198*/), 14936, 8},
	...
	{EIF_GENERIC(egt_13_981), 14947, 0},
	{EIF_GENERIC(egt_14_981), 14948, 0xFFFFFFFF},
...
void Init981(void)
{
	...
	IDSC(desc_981 + 34, 419, 980);
	IDSC(desc_981 + 36, 394, 980);
}
