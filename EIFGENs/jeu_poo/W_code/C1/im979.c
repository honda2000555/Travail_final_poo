...
extern EIF_TYPED_VALUE F979_8739(EIF_REFERENCE);
...
RTOID (F979_8739)
EIF_TYPED_VALUE F979_8739 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOQRR
	...
	RTEAA(l_feature_name, 978, Current, 0, 0, 14931);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(978, Current, 14931);
	RTIV(Current, RTAL);
	RTOQP;
	RTOC_GLOBAL(Result);
	RTHOOK(1);
