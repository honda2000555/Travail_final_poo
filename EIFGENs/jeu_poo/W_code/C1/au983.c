...
extern EIF_TYPED_VALUE F983_8773(EIF_REFERENCE);
extern void F983_10625(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F983_8773 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
void F983_10625 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 982, Current, 0, 10624);
	RTSA(dtype);
	RTME(dtype, 0);
