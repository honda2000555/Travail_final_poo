...
extern void F1018_9787(EIF_REFERENCE);
...
/* {APPLICATION}.make */
void F1018_9787 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub3 ub3x.it_b
	...
	RTEAA(l_feature_name, 1017, Current, 1, 0, 15993);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1017, Current, 15993);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTNHOOK(1,1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(7376, "enable_video", tr1))(tr1);
	RTHOOK(2);
	...
	ub2 = (EIF_BOOLEAN) 0;
	ub3 = (EIF_BOOLEAN) 0;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTVF(7207, "enable_image", tr1))(tr1, ub1x, ub2x, ub3x);
	RTHOOK(3);
	...
	RTNHOOK(3,1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(6641, "enable_sound", tr1))(tr1);
	RTHOOK(4);
	RTDBGAL(Current, 1, 0xF80003F8, 0, 0); /* loc1 */
	tr1 = RTLN(eif_new_type(1016, 0x01).id);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWC(7562, Dtype(tr1)))(tr1);
	RTNHOOK(4,1);
	loc1 = (EIF_REFERENCE) RTCCL(tr1);
	RTHOOK(5);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(7563, "run", loc1))(loc1);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(6);
	RTDBGLE;
